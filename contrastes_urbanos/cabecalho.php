...
<title>Olhar S&atilde;o Paulo &ndash; Contrastes Urbanos</title>
...
<?php  if (strpos($_SERVER['HTTP_HOST'], 'gbc300') === FALSE) { include("googleanalytics.php"); } ?>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="780" height="90">
    <tr><td height="90"><?php  if (strpos($_SERVER['HTTP_HOST'], 'gbc300') === FALSE) { include("headerprefeitura.php"); } ?></td></tr>
</table>
