...
<div id="menu">
  <ul>
    ...
    <li><a id="menu_e" href="javascript:carrega('equipe.php', 'e');">Equipe t&eacute;cnica</a></li><?php foreach ($estrutura as $i => $c) { ?>
    <li><a id="menu_<?php echo $i; ?>" href="javascript:carrega('pagina.php?i=<?php echo $i; ?>', '<?php echo $i; ?>');"><?php echo $c['titulo']; ?></a></li><?php } ?>
  ...
  <p style="margin: 25px 0 0 15px;"><a href="http://sempla.prefeitura.sp.gov.br" target="_top"><img src="img/logo_prefeitura.jpg" width="120" height="71" border="0" /></a></p>
</div>