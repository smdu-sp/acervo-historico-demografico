...
<head>
  <meta charset="UTF-8">
  <title>Munic&iacute;pio em Mapas &ndash; S&eacute;rie Tem&aacute;tica: Cultura e Territ&oacute;rio</title>
...
<body>
  ...
  <div id="geral">
    ...
    <div id="topo">
      ...
      <div id="serie">
        <h2>Cultura e Territ&oacute;rio</h2>
      </div>
    ...
    <div id="menu">
      <ul>
        ...
        <li><a href="" class="menu_e" data-url="historia.php">Breve hist&oacute;ria da pol&iacute;tica cultural paulistana</a></li>
        <li><a href="" class="menu_e" data-url="introducao.php">Introdu&ccedil;&atilde;o</a></li>
        <li><a href="" class="menu_e"  data-url="equipamentos.php">Equipamentos e bens culturais</a></li>
        <li><a href="" class="menu_e" data-url="eventos.php">Eventos, atividades de lazer e cultura</a></li>
        <li><a href="" class="menu_e" data-url="economia.php">Economia e cultura</a></li>
        <li><a href="" class="menu_e" data-url="download.php">Download</a></li>
      </ul>

      <p style="margin-left:15px;"><a href="http://smdu.prefeitura.sp.gov.br" target="_top"><img
