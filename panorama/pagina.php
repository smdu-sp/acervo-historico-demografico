...
<?php foreach ($estrutura[intval($_REQUEST['i'])]['pgs'] as $pg) { ?>
    <div id="pagina">
	    <a href="pdf/pag<?php printf("%02d", $pg); ?>.pdf" title="&lt;a href=&quot;pdf/pag<?php printf("%02d", $pg); ?>.pdf&quot; target=&quot;_blank&quot; title=&quot;Baixar em PDF&quot;&gt;Baixar em PDF&lt;/a&gt; &ndash; P&aacute;gina <?php printf("%02d", $pg); ?>"><img title="Clique para baixar o PDF" src="img/paginas/grande/pag<?php printf("%02d", $pg); ?>.jpg" width="594" height="841" /></a><br />
